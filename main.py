...
def create_main_menu():
    ...
    buttonStart     = UIElement.factory('button_start', "start_game_go_main_board", MAINMENU_USEREVENT, next(positions), button_size,\
    ...
    buttonConfig    = UIElement.factory('button_params_menu', "go_menu_params_config", MAINMENU_USEREVENT, next(positions),button_size,\
    ...
    buttonSound     = UIElement.factory('button_sound', "go_menu_sound_music", MAINMENU_USEREVENT, next(positions), button_size,\
    ...
    buttonGraphics  = UIElement.factory('button_graphics', "go_menu_graphics_display", MAINMENU_USEREVENT, next(positions), button_size,\
    ...
    main_menu   = Menu('main_menu', MAINMENU_USEREVENT, INITIAL_RESOLUTION, buttonStart, buttonConfig, buttonSound, buttonGraphics,
...
def create_config_menu():
    ...
    button_size         = next(positions)
    buttonGameModes     = UIElement.factory('button_game_mode', "change_game_mode", CONFIG_USEREVENT, next(positions), button_size,\
                                            INITIAL_RESOLUTION, default_values=GAMEMODES, text="Game Mode", text_alignment='left', gradient = (RED, BLACK))
    buttonCountPlayers  = UIElement.factory('button_players', "set_ammount_players", CONFIG_USEREVENT, next(positions), button_size,\
                                            INITIAL_RESOLUTION, default_values=(2, 4), text="Number of players", text_alignment='left', gradient = ((220, 0, 0, 255), (120, 120, 120, 255)))
    buttonNumPawns      = UIElement.factory('button_pawns', "set_ammount_pawns", CONFIG_USEREVENT, next(positions), button_size,\
                                            INITIAL_RESOLUTION, default_values=(4, 8), text="Number of pawns", text_alignment='left', gradient = ((170, 0, 0, 255), (170, 170, 170, 255)))
    buttonNumWarriors   = UIElement.factory('button_warriors', "set_ammount_warriors", CONFIG_USEREVENT, next(positions), button_size,\
                                            INITIAL_RESOLUTION, default_values=(1, 2, 4), text="Number of warriors", text_alignment='left', gradient = ((120, 0, 0, 255), (220, 220, 220, 255)))
    buttonNumWizards    = UIElement.factory('button_wizards', "set_ammount_wizards", CONFIG_USEREVENT, next(positions), button_size,
                                            INITIAL_RESOLUTION, default_values=(1, 2), text="Number of wizards", text_alignment='left')
    buttonNumPriestesses= UIElement.factory('button_priestesses', "set_ammount_priestess", CONFIG_USEREVENT, next(positions), button_size,\
                                            INITIAL_RESOLUTION, default_values=(1, 1), text="Number of priestess", text_alignment='left')
    params_menu = Menu("menu_params_config", CONFIG_USEREVENT, INITIAL_RESOLUTION, buttonGameModes, buttonCountPlayers, buttonNumPawns,\
...
def create_sound_menu():
    ...
    sliderMenuMusic     = UIElement.factory('slider_music_volume', "set_menu_music_volume", SOUND_USEREVENT, next(positions), button_size,\
    ...
    sliderMenuSounds    = UIElement.factory('slider_sound_volume', "set_menu_sound_volume", SOUND_USEREVENT, next(positions), button_size,\
                                            INITIAL_RESOLUTION, default_values=(0.75), text="Menus sound volume", slider_type='elliptical')
    sliderBoardMusic    = UIElement.factory('slider_board_music_volume', "set_board_music_volume", SOUND_USEREVENT, next(positions), button_size,\
                                            INITIAL_RESOLUTION, default_values=(0.75), text="Board music volume", slider_type='rectangular')
    sliderBoardSounds   = UIElement.factory('slider_board_sound_volume', "set_board_sound_volume", SOUND_USEREVENT, next(positions), button_size,\
                                            INITIAL_RESOLUTION, default_values=(0.75), text="Board sound volume")
    buttonBoardSongs    = UIElement.factory('button_board_song', 'change_board_song', SOUND_USEREVENT, next(positions), button_size,\
                                            INITIAL_RESOLUTION, default_values=BOARD_CROPPED_SONGS, text='Selected board song', text_proportion = 0.50)
    buttonMenusSongs    = UIElement.factory('button_menu_song', 'change_menu_song', SOUND_USEREVENT, next(positions), button_size,\
    ...
    sound_menu          = Menu("menu_volume_music", SOUND_USEREVENT, INITIAL_RESOLUTION, sliderMenuMusic, sliderMenuSounds, sliderBoardMusic, sliderBoardSounds,\
...
def create_video_menu():
    ...
    button_size         = next(positions)
    buttonRes   = UIElement.factory('button_resolution',"change_resolution_screen_display", GRAPHIC_USEREVENT, next(positions), button_size,\
                                    INITIAL_RESOLUTION, default_values=RESOLUTIONS, text="Resolution",text_alignment='left')
    buttonFps   = UIElement.factory('button_fps', "change_fps_frames_per_second", GRAPHIC_USEREVENT, next(positions), button_size,\
                                    INITIAL_RESOLUTION, default_values=ALL_FPS, text="Frames per second",text_alignment='left')
    buttonFullscreen = UIElement.factory('button_fps', "set_display_mode_fullscreen", GRAPHIC_USEREVENT, next(positions), button_size,\
                                INITIAL_RESOLUTION, default_values=('Off', 'On'), text="Fullscreen")                                    
    graphics_menu  = Menu("menu_graphics_display", GRAPHIC_USEREVENT, INITIAL_RESOLUTION, buttonRes, buttonFps, buttonFullscreen,\
