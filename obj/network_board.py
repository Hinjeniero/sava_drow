...
class NetworkBoard(Board):
    ...
    def get_all_servers(self):
        """Gets all the public servers' information and returns it.
        Returns:
            (List->Tuple->Anys):    A list of tuples, each one containing all of the information of one public server."""
    ...
    def show_my_turn_popup(self):
        """Shows the popup of turn change."""
